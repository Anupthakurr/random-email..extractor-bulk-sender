...
The app is divided into two main phases: Extraction and Outreach.

Phase 1: Email Extraction (Finding your targets)
Enter your Niche: In the top left panel, type a keyword for the specific type of student you are looking for (e.g., "Computer Science student India", "Python developer intern", or "IIT JEE").
Select Sources: Check the boxes for where you want the app to search (GitHub, Google, Bing, or Devfolio).
Start Search: Click the Start Extracting button.
Watch the Magic: The backend spins up automated "scrapers" that intelligently read search engine results and GitHub profiles, automatically bypassing rate limits. As it finds valid emails, they populate the live table on the right side of the screen along with their name and where they were found.
Phase 2: Bulk Outreach (Contacting your targets)
